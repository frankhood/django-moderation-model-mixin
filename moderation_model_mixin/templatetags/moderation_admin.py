...
@register.inclusion_tag(
    "admin/moderation/submit_line.html", takes_context=True
)
def moderation_submit_row(context):
    ...
    ctx = {
        ...
        "show_set_moderated": (
            ...
            and context[
                "original"
            ]  # context['original'].is_instant_winner and
            and context["original"].is_acceptable()
        ...
        "show_set_rejected": (
            ...
            and context["original"].is_rejectable()
            and context.get("original", None)
            and not is_popup
            and context["has_change_permission"]
        ),
