...
lint: ## check style with flake8
	flake8 moderation_model_mixin tests
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source moderation_model_mixin runtests.py tests
	coverage report -m
	coverage html
	open htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/django-moderation-model-mixin.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ moderation_model_mixin
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
